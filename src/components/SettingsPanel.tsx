  ...
  return (
    <section className="settings">
      ...
      <p className="muted small" style={{ marginTop: 8 }}>
        Pipeline: <strong>MiMo V2.5</strong> делает глобальный OCR/layout pass по всему документу, затем <strong>MiMo V2 Omni</strong> делает page OCR, pdfjs-сверку и дешёвый watchdog. DOCX рендерится как Word-документ; PPTX обрабатывается как PDF/визуальные страницы.
      </p>
    </section>
  );
}
